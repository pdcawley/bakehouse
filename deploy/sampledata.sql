...
COPY ingredient (ingredient, type, pack_size, unit, price, datestamp) FROM stdin;
...
COPY product (product, packaging_cost, labour_cost, delivery_cost, gross_margin, piece_rate) FROM stdin;
